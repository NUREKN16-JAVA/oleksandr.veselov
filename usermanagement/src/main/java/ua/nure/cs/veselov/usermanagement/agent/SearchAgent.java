package ua.nure.cs.veselov.usermanagement.agent;
...
public class SearchAgent extends Agent {
    ...
    protected void setup() {
        super.setup();
        System.out.println(getAID().getName() + " started work.");
            ...
            protected void onTick() {
                ...
                try {
                    ...
                    for (int i = 0; i < descriptions.length; ++i) {
                        DFAgentDescription currentDescription = descriptions[i];
                        aids[i] = currentDescription.getName();
                    }
                } catch (FIPAException e) {
                    e.printStackTrace();
                }
    ...
    protected void takeDown() {      
        System.out.println(getAID().getName() + " finished work.");
        try {
